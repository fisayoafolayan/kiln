...
Let's get started.`)
			...
			// bob generates into a dialect-named subdirectory e.g. psql/models/
			// This must match what bobgen.yaml sets as output.
			modelsDir := bobModelsDir(driver)
...
// bobGenName maps a driver name to the bob generator name.
func bobGenName(driver string) string {
	switch driver {
	case "mysql":
		return "mysql"
	case "sqlite":
...
// bobModelsDir returns the path where bob writes its generated models.
func bobModelsDir(driver string) string {
	return "./models"
}
